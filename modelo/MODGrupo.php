...
class MODGrupo extends MODbase{
	...
	function listarGrupo(){
		...
		$this->procedimiento='corres.ft_grupo_sel';
		$this->transaccion='CO_GRU_SEL';
	...
	function insertarGrupo(){
		...
		$this->procedimiento='corres.ft_grupo_ime';
		$this->transaccion='CO_GRU_INS';
