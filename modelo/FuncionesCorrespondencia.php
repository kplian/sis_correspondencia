...
class FuncionesCorrespondencia{
	...
	* Autor: rac*/
	function listarCorrespondenciaSimplificada(CTParametro $parametro){
		$obj=new MODCorrespondencia($parametro);
		$res=$obj->listarCorrespondenciaSimplificada();
		return $res;
	}
	...
	function listarCorrespondenciaDetalle(CTParametro $parametro){
		$obj=new MODCorrespondencia($parametro);
		$res=$obj->listarCorrespondenciaDetalle();
		return $res;
	}
	...
	function insertarCorrespondenciaDetalle(CTParametro $parametro){
		$obj=new MODCorrespondencia($parametro);
		$res=$obj->insertarCorrespondenciaDetalle();
		return $res;
	}
			
	function modificarCorrespondenciaDetalle(CTParametro $parametro){
		$obj=new MODCorrespondencia($parametro);
		$res=$obj->modificarCorrespondenciaDetalle();
		return $res;
	}
	
	function derivarCorrespondencia(CTParametro $parametro){
		$obj=new MODCorrespondencia($parametro);
		$res=$obj->derivarCorrespondencia();
		return $res;
	}
	
	function corregirCorrespondencia(CTParametro $parametro){
		$obj=new MODCorrespondencia($parametro);
	...
	function listarCorrespondenciaRecibida(CTParametro $parametro){
		$obj=new MODCorrespondencia($parametro);
		$res=$obj->listarCorrespondenciaRecibida();
		return $res;
	}
