  		...
  		--Sentencia de la consulta
			v_consulta:='select
                        ...
                        (CASE WHEN (cor.id_acciones is not null) then
                                ...
                                persona.nombre_completo1 as desc_persona,
                                (select ins.nombre from corres.tcorrespondencia cor2
                                inner join param.tinstitucion ins on ins.id_institucion=cor2.id_institucion
                                 where cor2.id_correspondencia=cor.id_origen)as desc_institucion,
                               -- insti.nombre as desc_institucion,
...
cor.id_correspondencia,
 ...
 coalesce((select fecha_reg ::timestamp
  ...
  order by corest.id_correspondencia_estado asc limit 1),''01-01-01''::timestamp)::timestamp as fecha_recepcion
