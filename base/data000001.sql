...
select pxp.f_insert_tfuncion ('corres.f_inserta_estados', 'Funcion para tabla     ', 'CORRES');
select pxp.f_insert_tfuncion ('corres.ft_asistente_permisos_sel', 'Funcion para tabla     ', 'CORRES');
select pxp.f_insert_tfuncion ('corres.ft_reporte_sel', 'Funcion para tabla     ', 'CORRES');
select pxp.f_insert_tfuncion ('corres.trig_correspondencia', 'Funcion para tabla     ', 'CORRES');
...
select pxp.f_insert_tprocedimiento ('CO_COREXT_INS', 'inserta el mensajero la correspondencia externa recibida(ENTRANTE)', 'si', '', '', 'corres.ft_correspondencia_ime');
