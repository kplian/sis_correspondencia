...
/**
 *@package pXP
 *@file RGeneralCorres.php
 *@author  Marcela Garcia
 *@date 26-06-2019
 *@description Reporte Correspondencia Externa
...
class RGeneralCorres extends  ReportePDF {
    ...
    function Header() {
        ...
        $this->SetFont('', '');
        $this->SetFillColor(192,192,192, true);
        $this->Cell($width_c2, $height, $this->datos_entidad['nombre'].$this->cortar_cadena(trim(' ('.$this->datos_entidad['direccion_matriz'].')'),55), 0, 0, 'L', false, '', 0, false, 'T', 'C');
